        ...
        {!emailConfirmed ? (
          ...
          >
            <Form className={styles.form}>
              ...
              />
              {submitEmailError && (
                <div className={styles.error}>{submitEmailError}</div>
              )}
          ...
          >
            <Form className={styles.form}>
              <Field name="OTP" placeholder="OTP" className={styles.input} />
              <ErrorMessage
                name="OTP"
                component="div"
                className={styles.error}
              />
              {submitOTPError && (
                <div className={styles.error}>{submitOTPError}</div>
              )}
              <button type="submit" className={styles.button}>
                Confirm OTP
              </button>
          ...
          >
            <Form className={styles.form}>
              ...
              />
              {changePasswordError && (
                <div className={styles.error}>{changePasswordError}</div>
              )}
              <button type="submit" className={styles.button}>
                Confirm
              </button>
